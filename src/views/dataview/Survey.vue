<template>
    <div id="dataview-survey" class="dataview-survey">
        <comp-nav active="/dataview/survey"></comp-nav>
        <section>
            <article>
                <div class="document">
                ...
                <el-card class="box-card">
                    <div class="opera">
                        <el-input placeholder="请输入要搜索的视图名" v-model="filter" clearable></el-input>
                        <el-button type="primary" @click="new_view">新建视图</el-button>
                    </div>
                    <div class="project">
                        <div class="access" style="font-size: 18px;font-weight: 700">Key</div>
                        ...
                        <div class="type" style="font-size: 18px;font-weight: 700">Type</div>
                    ...
                    >
                        ...
                        <div class="btn">
                            ...
                            <el-button type="text" @click="manage_project(i._id, i.name)">管理</el-button>
                        </div>
                    </div>
                </el-card>
            </article>
...
export default {
    ...
    methods: {
        ...
        add_project() {
            ...
            this.axios({
                url: self.url + "/api/dataview/view/",
                method: "post",
        ...
        delete_project(_id) {
            this.$confirm("确认删除？", "确认:", { type: "error" })
                .then(_ => {
                    ...
                    this.openFullScreen();
                    this.axios
                        .delete(self.url + "/api/dataview/view/", {
                            data: {
        ...
        manage_project(_id, name) {
            this.$router.push({ name: "dataview-datav", query: { _id: _id, name: name} });
        }
    },
    mounted() {
        ...
        this.openFullScreen();
        this.axios
            .get(self.url + "/api/dataview/view/", {
                params: {
                    user_id: self.user._id
                }
            })

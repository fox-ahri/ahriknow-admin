  ...
  routes: [
    ...
    },
    {
      ...
      children: [{
        ...
        component: () => import(/* webpackChunkName: "database-survey" */ './views/database/Survey.vue'),
      }]
    }, {
      path: '/notebook',
      name: 'notebook',
      ...
      component: () => import(/* webpackChunkName: "restful" */ './views/Restful.vue'),
      ...
      children: [{
        ...
        component: () => import(/* webpackChunkName: "restful-survey" */ './views/restful/Survey.vue'),
      }, {
        path: 'api',
        name: 'restful-api',
        meta: {
        ...
        component: () => import(/* webpackChunkName: "restful-api" */ './views/restful/Api.vue'),
      }]
    }, {
      path: '/setting',
      name: 'setting',
      ...
      children: [{
        ...
        component: () => import(/* webpackChunkName: "setting-document" */ './views/setting/Document.vue'),
      }, {
        path: 'apply',
        name: 'setting-apply',
        meta: {
        ...
        component: () => import(/* webpackChunkName: "setting-apply" */ './views/setting/Apply.vue'),
      }]
    }, {
      path: '/transfer',
      name: 'transfer',
      ...
      children: [{
        ...
        component: () => import(/* webpackChunkName: "website-survey" */ './views/website/Survey.vue'),
      }]
    }, {
      path: '/dbm',
      name: 'dbm',
      component: () => import(/* webpackChunkName: "dbm" */ './views/DBM.vue'),
      redirect: "/dbm/mysql-auth",
      children: [{
        path: 'mysql-auth',
        name: 'dbm-mysql-auth',
        component: () => import(/* webpackChunkName: "dbm-mysql-auth" */ './views/dbm/mysql/Auth.vue'),
      }, {
        path: 'mysql-mysql',
        name: 'dbm-mysql-mysql',
        component: () => import(/* webpackChunkName: "dbm-mysql-mysql" */ './views/dbm/mysql/Mysql.vue'),
      }, {
        path: 'mongo-auth',
        name: 'dbm-mongo-auth',
        component: () => import(/* webpackChunkName: "dbm-mongo-auth" */ './views/dbm/mongo/Auth.vue'),
      }, {
        path: 'mongo-mongo',
        name: 'dbm-mongo-mongo',
        component: () => import(/* webpackChunkName: "dbm-mongo-mongo" */ './views/dbm/mongo/Mongo.vue'),
      }]
    },
    {
      path: '*',
